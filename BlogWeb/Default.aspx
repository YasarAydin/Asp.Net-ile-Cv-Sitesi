                    ...
                    <div class="my-auto">
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                <h3 class="mb-0">
                                    <asp:Label ID="Label6" runat="server" Text='<%# Eval("BASLIK") %>'></asp:Label></h3>
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label7" runat="server" Text='<%# Eval("ALTBASLIK") %>'></asp:Label>
                                </div>
                                <p>
                    ...
                    <div class="resume-item d-flex flex-column flex-md-row mb-5">
                        <div class="resume-content mr-auto">
                            <h3 class="mb-0">
                                <asp:Label ID="Label6" runat="server" Text='<%# Eval("BASLIK") %>'></asp:Label></h3>
                            <div class="subheading mb-3">
                                <asp:Label ID="Label10" runat="server" Text='<%# Eval("ALTBASLIK") %>'></asp:Label>
                            </div>
                            <div>
                                <asp:Label ID="Label11" runat="server" Text='<%# Eval("ACIKLAMA") %>'></asp:Label>
                            </div>
                            <p>
